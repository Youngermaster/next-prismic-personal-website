...
export default function Home({ page }) {
  return (
    <>
      ...
      <main className='page-pancake bright-grey white-text'>

        <NavBar />

        <SliceZone slices={page.data.slices} components={components} />

        {/* <section className="pad" id="education">
          <div className="smush ">
        ...
        <footer className="black pad">
          <div className='smush aureole three'>
            <div>
              <p className='bold'>Contact:</p>
              <p>
                <span className='bold'>Email: </span>andresguerra0625@email.com
              </p>
              <p>
                <span className='bold'>Phone:</span> +57 300 898 4150
              </p>
            </div>
            <div>
            <p className='bold'>
          ...
          <div>
            <a href="https://www.instagram.com/andresguerra214/" target='_blank' className="white-text item mod-detail">
            ...
            <div>
              <p className='bold'>©2023 Andres Guerra Montoya. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
